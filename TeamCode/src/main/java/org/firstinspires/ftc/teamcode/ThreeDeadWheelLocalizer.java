...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        ...
        public double par0YTicks = 2253.8121750243445; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = -2197.010823124036; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = 1634.767916697142; // x position of the perpendicular encoder (in tick units)
    }
