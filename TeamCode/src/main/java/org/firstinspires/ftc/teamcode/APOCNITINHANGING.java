...
@TeleOp (name="APOC NITIN HANGING")

public class APOCNITINHANGING extends OpMode {
    ...
    ElapsedTime hanging_timer = new ElapsedTime();
       ...
       int count = 0;
        ...
        if (gamepad2.b){
            ...
            while (count == 1){
                ...
                try {
                    rightLSM.setPower(0.25);
                    leftLSM.setPower(0.25);
                    Thread.sleep(5000);
                    ...
                    while (count_2 == 2){
                        speed -= 0.04;
                        rightLSM.setPower(speed);
                        leftLSM.setPower(speed);
                        try {
                            Thread.sleep(100);
                        } catch (InterruptedException e) {
                            throw new RuntimeException(e);
