 ...
 */
@Autonomous(name = "FTC Wires RedLeftIntakeLedu", group = "00-Autonomous", preselectTeleOp = "FTC Wires TeleOp")
public class FTCWiresRedLeftIntakeLedu extends LinearOpMode {
            ...
            case RED_LEFT:
                ...
                switch (identifiedSpikeMarkLocation) {
                    ...
                    case MIDDLE:
                        ...
                        midwayPose2 = new Pose2d(50, -80, Math.toRadians(-91.5));
                        waitSecondsBeforeDrop = 2; //TODO: Adjust time to wait for alliance partner to move from board
